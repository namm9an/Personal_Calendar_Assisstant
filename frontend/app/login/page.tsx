    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          <p className="text-xl opacity-90">Continue your journey with AI-powered scheduling</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
            ...
            <p className="text-center text-gray-600 mt-6">
              ...
              <Link href="/signup" className="text-indigo-600 hover:text-indigo-700 font-medium ml-1">Sign up</Link>
            </p>
          </div>
        </div>
      </div>
