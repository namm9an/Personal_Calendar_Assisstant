    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          >
            Start your journey with AI-powered scheduling
          </motion.p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          >
            <h1 className="text-4xl font-bold mb-2 text-white">
              Your AI Calendar
              <br />
              <span className="text-6xl md:text-7xl lg:text-8xl bg-clip-text text-transparent bg-gradient-to-r from-accent via-primary to-secondary animate-gradient-shift bg-[length:200%_auto]">Reimagined</span>
            </h1>
          </motion.div>
